...
predicted_probabilities <- predict(PD_LOGIT, newdata = data1, type = "response")
results <- data.frame(Application_ID = data1$Application_ID, Score = predicted_probabilities)
write.csv(results, file = "model_results.csv", row.names = FALSE)
write_xlsx(results, "model_results.xlsx")
